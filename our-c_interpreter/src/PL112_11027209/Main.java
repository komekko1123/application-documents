...
class Evalutor {
  ...
  public void FetchToken() throws Throwable {    
    if ( mTCt == mTL.size() ) { // STOP 
      mTCt++;
    } // if
    
    else if ( mTCt < mTL.size() ) {  // 有token就把count往前挪，不抓
      mTCt++;
    } // else if
  } // FetchToken()
  
  public void GoType_Specifier() throws Throwable { // 這個加
    if ( IsType_Specifier() == true ) 
      FetchToken();
  } // GoType_Specifier()
 
  
  public void GoRest_Of_Declarators() throws Throwable {
    int typetemp = mTCt-2;
    Identifier t;
    if ( mTL.get( mTCt ).mtype == G.LMP ) {
      FetchToken();
      if ( mTL.get( mTCt ).mtype == G.CONSTANT ) {
      } // if
      
      t = new Identifier( mTL.get( typetemp ).mtype, 
                          Integer.parseInt( mTL.get( mTCt ).mvalue ),
                          mTL.get( mTCt-2 ).mvalue, true );
      mIdeL.add( t );
      
      FetchToken();
      if ( mTL.get( mTCt ).mtype == G.RMP ) {
      } // if
          
      FetchToken();
    } // if  
     
    else if ( mTL.get( mTCt ).mtype != G.LMP ) { // for 區域變數
      t = new Identifier( mTL.get( typetemp ).mtype, 0, mTL.get( mTCt-1 ).mvalue, false );
      mIdeL.add( t );  
    } // else if
    
    while ( mTL.get( mTCt ).mtype == G.CM  ) { // 可有可無
      FetchToken();
      if ( mTL.get( mTCt ).mtype == G.IDENT  ) { 
      } // if 
    ...
    if (  mTL.get( mTCt ).mtype == G.SC  ) {
      return;  
    } // if
  } // GoRest_Of_Declarators()
  
  public void GoCompound_Statement() throws Throwable {
    int goback = mIdeL.size();
    if ( mTL.get( mTCt ).mtype == G.LBP ) {
    } // if
    ...
    while ( IsType_Specifier() || IsStatement() ) { // declaration是type開頭
      ...
      FetchToken(); // 可能不用先放著放著放著
    } // while
    
    if ( mTL.get( mTCt ).mtype != G.RBP ) {
    } // if
    
    else { // 最後一個是右大刮
      while ( goback < mIdeL.size() ) { // 要退回
        mIdeL.remove( mIdeL.size() - 1 );  
      } // while
    } // else
  } // GoCompound_Statement()
  
  public void GoDeclaration() throws Throwable {
    GoType_Specifier();
    if ( mTL.get( mTCt ).mtype == G.IDENT ) {
    } // if
    
    FetchToken();
    if ( mTL.get( mTCt ).mtype == G.LMP || mTL.get( mTCt ).mtype == G.SC || 
         mTL.get( mTCt ).mtype == G.CM ) {
      GoRest_Of_Declarators(); 
    } // if
  } // GoDeclaration()
  
  public void GoStatement() throws Throwable {
    if (  mTL.get( mTCt ).mtype == G.SC ) { // 
    } // if
    ...
    else if (  mTL.get( mTCt ).mtype == G.RETURN ) {
      FetchToken();
      if (  IsExpression() == true ) {
        GoExpression();
      } // if
    ...
    else if (  mTL.get( mTCt ).mtype == G.LBP ) {
      GoCompound_Statement();
    } // else if
    
    else if (  mTL.get( mTCt ).mtype == G.IF ) {
      FetchToken();
      if (  mTL.get( mTCt ).mtype == G.LSP ) {
      } // if
      
      FetchToken();
      GoExpression();
           
      if (  mTL.get( mTCt ).mtype == G.RSP ) {
      } // if
      
      FetchToken();
      GoStatement();
      FetchToken();
      if ( mTCt == mTL.size() ) // 沒有else
        return;
      if ( mTL.get( mTCt ).mtype == G.ELSE ) {
        FetchToken();
        GoStatement();
      } // if
    } // else if
    
    else if (  mTL.get( mTCt ).mtype == G.WHILE ) {
      FetchToken();
      if (  mTL.get( mTCt ).mtype == G.LSP ) {
      } // if
    ...
    else if (  mTL.get( mTCt ).mtype == G.DO ) {
      FetchToken();
      GoStatement();
      if ( mTL.get( mTCt ).mtype == G.WHILE ) {
      } // if
  ...
  public void GoExpression() throws Throwable {
    GoBasic_Expression();
    while ( mTL.get( mTCt ).mtype == G.CM ) {
      FetchToken();
      GoBasic_Expression();
    } // while
  } // GoExpression()
  ...
  public void GoBasic_Expression() throws Throwable {
    ...
    else if ( mTL.get( mTCt ).mtype == G.PP ||  mTL.get( mTCt ).mtype == G.MM  ) {
      FetchToken();
      if ( mTL.get( mTCt ).mtype == G.IDENT ) {
        FetchToken();
        GoRest_Of_PPMM_Identifier_Started_Basic_Exp();
    ...
    else if ( mTL.get( mTCt ).mtype == G.CONSTANT ) {
      FetchToken();
      GoRomce_And_Romloe();
    } // else if 
    
    else if ( mTL.get( mTCt ).mtype == G.LSP ) {
      FetchToken();
      GoExpression();
      if (  mTL.get( mTCt ).mtype == G.RSP ) {
      } // if     
  ...
  public void GoRest_Of_Identifier_Started_Basic_Exp() throws Throwable {
    if ( mTL.get( mTCt ).mtype == G.LSP ) {
      FetchToken(); // 可能要FETCHTOKEN 
    ...
    else if (  mTL.get( mTCt ).mtype == G.LMP ) {
      FetchToken(); // 可能要FETCHTOKEN
      GoExpression();
    ...
    if ( IsAssignment_Operator() == true ) {
      ...
      if ( mTL.get( mTCt ).mtype == G.PP || mTL.get( mTCt ).mtype == G.MM ) {
        FetchToken();
      } // if
  ...
  public void GoRest_Of_PPMM_Identifier_Started_Basic_Exp() throws Throwable {
    if (  mTL.get( mTCt ).mtype == G.LMP ) {
      FetchToken();
      GoExpression();
      if (  mTL.get( mTCt ).mtype == G.RMP ) {
  ...
  public void GoSign() throws Throwable {
    if ( IsSign() == true ) {
      FetchToken();  
    } // if
  } // GoSign()
  
  public void GoActual_Parameter_List() throws Throwable {
    GoBasic_Expression();
    while ( mTL.get( mTCt ).mtype == G.CM ) {
      FetchToken();
      GoBasic_Expression();
  ...
  public void GoAssignment_Operator() throws Throwable {
    if ( IsAssignment_Operator() == true ) {
      FetchToken(); // 可能要FETCHTOKEN
    } // if
  } // GoAssignment_Operator()
  
  public void GoRomce_And_Romloe() throws Throwable {
    GoRest_Of_Maybe_Logical_OR_Exp();
    
    if ( mTL.get( mTCt ).mtype == G.QM ) {
      FetchToken();
      GoBasic_Expression();
      if (  mTL.get( mTCt ).mtype == G.CL ) {
      } // if
  ...
  public void GoRest_Of_Maybe_Logical_OR_Exp() throws Throwable {
    GoRest_Of_Maybe_Logical_AND_Exp();
  
    while ( mTL.get( mTCt ).mtype == G.OR ) {
      FetchToken();
      GoMaybe_Logical_AND_Exp();
    } // while
  } // GoRest_Of_Maybe_Logical_OR_Exp()
  ...
  public void GoMaybe_Logical_AND_Exp() throws Throwable {
    GoMaybe_Bit_OR_Exp();

    while ( mTL.get( mTCt ).mtype == G.AND ) {
      FetchToken();
      GoMaybe_Bit_OR_Exp();
    } // while 
  } // GoMaybe_Logical_AND_Exp()
  
  public void GoRest_Of_Maybe_Logical_AND_Exp() throws Throwable {
    GoRest_Of_Maybe_Bit_OR_Exp();
  ...
  public void GoMaybe_Bit_OR_Exp() throws Throwable {
    GoMaybe_Bit_Ex_OR_Exp();
    
    while ( mTL.get( mTCt ).mtype == G.HALF_OR ) {
      FetchToken();
      GoMaybe_Bit_Ex_OR_Exp();
    } // while
  } // GoMaybe_Bit_OR_Exp()
  
  public void GoRest_Of_Maybe_Bit_OR_Exp() throws Throwable {
    GoRest_Of_Maybe_Bit_Ex_OR_Exp();
    while ( mTL.get( mTCt ).mtype == G.HALF_OR ) {
      FetchToken();
      GoMaybe_Bit_Ex_OR_Exp();
  ...
  public void GoMaybe_Bit_Ex_OR_Exp() throws Throwable {
    GoMaybe_Bit_AND_Exp();

    while ( mTL.get( mTCt ).mtype == G.HAT ) {
      FetchToken();
      GoMaybe_Bit_AND_Exp();
    } // while
  } // GoMaybe_Bit_Ex_OR_Exp()
  
  public void GoRest_Of_Maybe_Bit_Ex_OR_Exp() throws Throwable {
    GoRest_Of_Maybe_Bit_AND_Exp();
    while ( mTL.get( mTCt ).mtype == G.HAT ) {
      FetchToken();
      GoMaybe_Bit_AND_Exp();
  ...
  public void GoMaybe_Bit_AND_Exp() throws Throwable {
    GoMaybe_Equality_Exp();
    while ( mTL.get( mTCt ).mtype == G.HALF_AND ) {
      FetchToken();
      GoMaybe_Equality_Exp();
    } // while
  } // GoMaybe_Bit_AND_Exp()
  
  public void GoRest_Of_Maybe_Bit_AND_Exp() throws Throwable {
    GoRest_Of_Maybe_Equality_Exp();
    while ( mTL.get( mTCt ).mtype == G.HALF_AND ) {
      FetchToken();
      GoMaybe_Equality_Exp();
  ...
  public void GoMaybe_Equality_Exp() throws Throwable {
    GoMaybe_Relational_Exp();

    while ( mTL.get( mTCt ).mtype == G.EQ || mTL.get( mTCt ).mtype == G.NEQ  ) {
      FetchToken();
      GoMaybe_Relational_Exp();
    } // while
  } // GoMaybe_Equality_Exp()
  
  public void GoRest_Of_Maybe_Equality_Exp() throws Throwable {
    GoRest_Of_Maybe_Relational_Exp();   
    while ( mTL.get( mTCt ).mtype == G.EQ  || mTL.get( mTCt ).mtype == G.NEQ  ) {
      FetchToken();
      GoMaybe_Relational_Exp();
  ...
  public void GoMaybe_Relational_Exp() throws Throwable {
    GoMaybe_Shift_Exp();
    while (  mTL.get( mTCt ).mtype == G.GE  || mTL.get( mTCt ).mtype == G.LE ||
            mTL.get( mTCt ).mtype == G.GT  || mTL.get( mTCt ).mtype == G.LT ) {
      FetchToken();
      GoMaybe_Shift_Exp();
    } // while
  } // GoMaybe_Relational_Exp()
  
  public void GoRest_Of_Maybe_Relational_Exp() throws Throwable {
    GoRest_Of_Maybe_Shift_Exp();
    while (  mTL.get( mTCt ).mtype == G.GE  || mTL.get( mTCt ).mtype == G.LE ||
            mTL.get( mTCt ).mtype == G.GT  || mTL.get( mTCt ).mtype == G.LT ) {
      FetchToken();
  ...
  public void GoMaybe_Shift_Exp() throws Throwable {
    GoMaybe_Additive_Exp();
    while (  mTL.get( mTCt ).mtype == G.LS  || mTL.get( mTCt ).mtype == G.RS ) {
      FetchToken();
      GoMaybe_Additive_Exp();
    } // while
  } // GoMaybe_Shift_Exp()
  
  public void GoRest_Of_Maybe_Shift_Exp() throws Throwable {
    GoRest_Of_Maybe_Additive_Exp();
    while (  mTL.get( mTCt ).mtype == G.LS  || mTL.get( mTCt ).mtype == G.RS ) {
      FetchToken();
      GoMaybe_Additive_Exp();
  ...
  public void GoMaybe_Additive_Exp() throws Throwable {
    GoMaybe_Mult_Exp();
    while ( mTL.get( mTCt ).mtype == G.PLUS || mTL.get( mTCt ).mtype == G.MINUS ) {
      FetchToken();
      GoMaybe_Mult_Exp();
    } // while
  } // GoMaybe_Additive_Exp()
  
  public void GoRest_Of_Maybe_Additive_Exp() throws Throwable {
    GoRest_Of_Maybe_Mult_Exp();   
    while ( mTL.get( mTCt ).mtype == G.PLUS || mTL.get( mTCt ).mtype == G.MINUS ) {
      FetchToken();
      GoMaybe_Mult_Exp();
  ...
  public void GoMaybe_Mult_Exp() throws Throwable {
    GoUnary_Exp();
    GoRest_Of_Maybe_Mult_Exp();
  } // GoMaybe_Mult_Exp()
  
  public void GoRest_Of_Maybe_Mult_Exp() throws Throwable {
    while ( mTL.get( mTCt ).mtype == G.STAR || mTL.get( mTCt ).mtype == G.DIV ||
            mTL.get( mTCt ).mtype == G.PERCENT ) {
      FetchToken();
      GoUnary_Exp();
    } // while
  } // GoRest_Of_Maybe_Mult_Exp()
  ...
  public void GoUnary_Exp() throws Throwable {
    if ( IsSign() == true ) {
      FetchToken();
      while ( IsSign() == true ) {
        FetchToken();
  ...
  public void GoSigned_Unary_Exp() throws Throwable {
    if ( mTL.get( mTCt ).mtype == G.IDENT ) {
      FetchToken();  
      if ( mTL.get( mTCt ).mtype == G.LSP ) {
        FetchToken(); // 可能要FETCHTOKEN 
  ...
  public void GoUnsigned_Unary_Exp() throws Throwable {
    if ( mTL.get( mTCt ).mtype == G.IDENT ) {
      FetchToken();
      if ( mTL.get( mTCt ).mtype == G.LSP ) {
        FetchToken(); // 可能要FETCHTOKEN 
  ...
  public boolean IsSign() throws Throwable {
    if ( mTL.get( mTCt ).mtype == G.PLUS || mTL.get( mTCt ).mtype == G.MINUS ||
         mTL.get( mTCt ).mtype == G.HALF_NEQ )
      return true;
    else 
      return false;
  ...
  public boolean IsStatement() throws Throwable { // 看statement的前綴字
    if ( mTL.get( mTCt ).mtype == G.SC     || IsExpression() ||
         mTL.get( mTCt ).mtype == G.RETURN || IsCompound_Statement()  || 
         mTL.get( mTCt ).mtype == G.IF  ||  mTL.get( mTCt ).mtype == G.WHILE  ||  
         mTL.get( mTCt ).mtype == G.DO )
      return true;
    else 
      return false;
  } // IsStatement() 
  ...
  public boolean IsExpression() throws Throwable { // expression就是basic_expression
    if ( mTL.get( mTCt ).mtype == G.IDENT    || mTL.get( mTCt ).mtype == G.PP ||
         mTL.get( mTCt ).mtype == G.MM   ||  mTL.get( mTCt ).mtype == G.CONSTANT  || 
         mTL.get( mTCt ).mtype == G.LSP || IsSign() )      
      return true;
    else 
      return false;
  } // IsExpression() 
  ...
  public boolean IsType_Specifier() throws Throwable {
    if ( mTL.get( mTCt ).mtype == G.INT || mTL.get( mTCt ).mtype == G.CHAR ||
         mTL.get( mTCt ).mtype == G.FLOAT || mTL.get( mTCt ).mtype == G.STRING  || 
         mTL.get( mTCt ).mtype == G.BOOL  )
      return true;
    else 
      return false;
  } // IsType_Specifier() 
  ...
  public boolean IsAssignment_Operator() throws Throwable {
    if ( mTL.get( mTCt ).mtype == G.HALF_EQ || mTL.get( mTCt ).mtype == G.TE ||
         mTL.get( mTCt ).mtype == G.DE       || mTL.get( mTCt ).mtype == G.RE  || 
         mTL.get( mTCt ).mtype == G.PE       || mTL.get( mTCt ).mtype == G.ME  )
      return true;
    else 
      return false;
  } // IsAssignment_Operator() 
